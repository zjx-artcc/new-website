...
<div class="space-x-16 pl-10 z-10">
	...
	{:else}
		<button on:click={signIn('vatsim')} class="text-lg text-stone-200 inline-flex align-middle" id="index"><Icon icon="ic:baseline-log-in" class="pt-1.5 navbarIcon" /> Login</button>
	{/if}
</div>