...
<a href="/" class="text-lg text-stone-200 inline-flex" id="pilots" on:click={() => showDropdown('pilots')}><Icon icon="mdi:airplane" class="pt-1.5" style="width: 30px; height: 25px;" /> Pilots</a>
