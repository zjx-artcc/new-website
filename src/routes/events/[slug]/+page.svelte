  ...
  <div class="relative z-0">
    ...
    <div class="relative z-2">
      <div class="w-full flex flex-col justify-center items-center container text-center m-auto p-[5rem]">
        ...
        <div class="pt-5">
          <button on:click={prompt} class="bg-red-500 text-white px-2 py-1 rounded-md text-xl">Delete</button>
          <button class="bg-blue-500 text-white px-2 py-1 rounded-md text-xl">Edit</button>
        </div>
      </div>
    </div>
  </div>
